...
uint8_t CRC::Get_CRC8_Check_Sum(uint8_t *pchMessage, uint8_t dwLength, uint8_t ucCRC8) {
    uint8_t ucIndex;
    while (dwLength--) {
...
uint8_t CRC::Verify_CRC8_Check_Sum(uint8_t *pchMessage, uint8_t dwLength) {
...
uint16_t CRC::Verify_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength) {
    if (pchMessage == nullptr) return 0;
